  ...
  return (
    <section className="w-full h-screen relative text-white overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col justify-center px-10 md:px-20">
        {/* Heading */}
        <h1 className="text-4xl md:text-6xl font-semibold leading-tight max-w-[600px]">
          Rest easy, power up your mornings
        </h1>

        {/* Timer (bottom right) */}
        <div className="absolute bottom-20 right-16 text-gray-200">
        ...
        {/* Info Card */}
        <div className="absolute bottom-10 left-10 bg-[#1B1D1F]/80 backdrop-blur-md border border-white/10 rounded-xl px-6 py-5 max-w-md">
          ...
          <p className="text-gray-300 text-sm leading-relaxed">
            This could affect your overall productivity throughout the day.
            Try taking up lighter tasks.
          </p>
        </div>
      </div>
    </section>
